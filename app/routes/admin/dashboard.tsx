...
import {ColumnDirective, ColumnsDirective, GridComponent, headerDrop, Inject} from "@syncfusion/ej2-react-grids";
...
export const clientLoader = async () => {
  ...
  const allTrip = trips.allTrips.map(({ $id, tripDetails, imageUrl}) => ({
    id: $id,
...
const Dashboard = ({loaderData}: Route.ComponentProps) => {
  ...
  const {dashboardStats, allTrips, userGrowth, tripsByTravelStyle, allUsera} = loaderData;
  ...
  return (
    <main className="dashboard wrapper">
      ...
      <section className="user-trip-wrapper">
          {userAndTrip.map(({ title, dataSource, field, headerText}, i) => (
