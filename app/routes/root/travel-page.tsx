                    ...
                    <section className="wrapper">
                        <article>
                            ...
                            <p className="text-dark-100">
                                Customize your travel itinerary in minutes-pick destination, set your preference, and explore with confidence.
                            </p>
                        </article>

                        <Link to="#trips">
                            <ButtonComponent type="buttom" className="button-class !h-11 1w-full md:!w-[240px]">
